      ...
      <div className="container max-w-lg">
        <div className="mx-auto mb-8 w-full max-w-lg text-center md:mb-10 lg:mb-12">
          ...
          <p className="md:text-md">
            Reach out for inquiries or to schedule a session.
          </p>
        </div>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Parent Inquiry" id="#first_choice" />
                <Label htmlFor="#first_choice">Parent Inquiry</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Student Inquiry</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Tutor Inquiry</Label>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#other">None</Label>
              </div>
            </RadioGroup>
          </div>
          <div className="grid w-full items-center">
